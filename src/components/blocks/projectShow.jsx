export default function project({imageSrc, imageAlt, projectName, projectLink}) {
    return (
        <div className=" px-8 text-center max-w-full">
            <div className="relative h-auto mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[8px] rounded-t-xl max-w-[301px] md:max-w-[512px]">
                <div className="rounded-lg overflow-hidden h-auto bg-white dark:bg-gray-800">								
